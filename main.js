...
let group, objGroup, textMesh1, dateTextMesh, yearTextMesh, unitTextMesh, textGeo, unitTextGeo, dateTextGeo, yearTextGeo, materials, bbox, namebbox;
...
const slaObjLoader = new OBJLoader();
...
function loadOBJ() {
    slaObjLoader.load(
        ...
        function (object) {
            ...
            //box.getCenter(object.postion);
            
            //object.geometry.center();
            //objGroup.add( object );
            //bbox = new THREE.Box3();
            //bbox.setFromObject(objGroup);
            //console.log("Bounding box details are:");
            //console.log(bbox.min);
            //console.log(bbox.max);
            //objGroup.geometry.center();
            //objGroup.scale.y = 0.5;

            //scene.add(objGroup);
            bbox = new THREE.Box3();
            bbox.setFromObject(object);
            console.log("OBJ bounding box details are:");
            console.log(bbox.min);
            console.log(bbox.max);
            group.add(object);
        },
        ...
        function(error) {
            console.log('An error happened while trying to load the object');
        }
    );
}
